...
if uploaded_csv_files:
    ...
    st.write("Dictionaries and ML model updated successfully.")
...
if st.button("Translate Text"):
    if text_to_translate:
        # Optionally using machine learning model
        if st.checkbox("Use machine learning for translation"):
            translated_text = translate_with_ml(text_to_translate)
        else:
