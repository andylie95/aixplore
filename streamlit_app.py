...
from translate_codebase import (load_dictionaries, train_translation_model, translate_with_model,
                                ...
                                translate_pptx, save_translated_file, detect_language)
...
uploaded_csv_files = st.file_uploader("Upload CSV files as dictionary to train your model for enhanced contextualised translation", type="csv", accept_multiple_files=True)
