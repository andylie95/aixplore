...
uploaded_file = st.file_uploader("Upload a document", type=["docx", "xlsx", "pptx", "txt", "srt", "vtt", "csv"])
if uploaded_file:
...
rating_html = """
<div id="rating" style="display: flex; flex-direction: row;">
