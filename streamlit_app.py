...
if st.button("Translate Text"):
    if text_to_translate:
        ...
        if models:
            translated_text = translate_with_model(text_to_translate, detected_language, target_language, models)
        else:
...
if uploaded_file:
    ...
    if file_type == "docx":
        ...
        translated_pdf_writer = translate_pdf(pdf_reader, target_language, translation_dict, models)
