...
def save_rating_to_google_sheet(rating, description):
    scope = ["https://spreadsheets.google.com/feeds", "https://www.googleapis.com/auth/drive"]
    creds = ServiceAccountCredentials.from_json_keyfile_name('api-write-427400-937ef3b80e17.json', scope)
    client = gspread.authorize(creds)
    
    sheet = client.open_by_url('https://docs.google.com/spreadsheets/d/1LZBsQS2e49o-cP59L7PUeQ7bt_xfZ-dO4ztWMuz2Z_8/edit#gid=0')
    worksheet = sheet.get_worksheet(0)
    worksheet.append_row([rating, description])
...
if uploaded_file:
    ...
    if file_type == "docx":
        ...
        st.successThe code snippet provided was cut off, so here's the complete implementation of the `streamlit_app.py`:
